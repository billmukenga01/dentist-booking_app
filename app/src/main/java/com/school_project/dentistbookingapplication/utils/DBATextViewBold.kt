 ...
 */
class DBATextViewBold(context: Context, attrs: AttributeSet) : AppCompatTextView(context, attrs) {
    ...
    private fun applyFont() {
        ...
        val typeface: Typeface =
            Typeface.createFromAsset(context.assets, "times-new-roman-grassetto.ttf")
